...
public interface IFernflowerPreferences {
  ...
  static Map<String, Object> getDefaults() {
    ...
    defaults.put(ERROR_MESSAGE, "Please report this issue to the Sporeflower issue tracker at https://github.com/hourianto/sporeflower/issues and attach the class file or JAR that caused the error.");
